...
const Page = (_props: { system: any }) => {
  ...
  return (
    <Body className={`w-element`}>
      <h1 className={`w-element c1anbojs cpf8n67 ctg9xgo cavlpe`}>
        {"Devmat Solutions PC"}
      </h1>
      <h2 className={`w-element cavlpe c153cr87`}>
        {SiteState?.data?.data?.siteStatus}
      </h2>
      <Image
        src={
          "/assets/work-in-progress_9kwdBfP1AlkQIoCBpUhxT_tzCv1ntJfGV095tFowbBF.webp"
        }
        width={300}
        height={300}
        alt={""}
